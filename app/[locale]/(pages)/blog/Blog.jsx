            ...
            <div className={styles.top}>
              ...
              <Dialog.Root modal={true}>
                    <Dialog.Trigger asChild>
                        <div className={styles.top_mobile_right}>
                            <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Filter">
                                    ...
                                    <CategoriesBox title="All Categories" icon={<Filter size={18} />}>
                                        <ul className={styles.sidebarCategoryList}>
                                            {posts?.categories?.map(category => (
                                                <li key={category.id} onClick={() => updateFilter('category', category.id)}>
                                                    <span>{category.name}</span>
                                                    <div className={styles.badgeWrapper} >
                                                        <span className={styles.badge}>{category.post_count}</span>
                                ...
                                <>
                                    ...
                                    <div className={styles.latestPosts}>
                                        <div className={styles.title}>
                                            <div className={styles.left}>
                                                <div className={styles.icon}>
                                                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Latest Posts">
                                        ...
                                        <div className={styles.follow}>
                                            <button>
                                                <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg" aria-label="Follow @britishacademy">
